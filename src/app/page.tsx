          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className={`${smythe.className} text-xl font-bold leading-6 text-gray-900`}
              >
                {item.name}
              </Link>
            ))}
        ...
        <div className="flex-row mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link
                href="#"
                className="relative px-3.5 py-2.5 text-lg rounded-full ring-1 hover:ring-gray-900/20 font-semibold leading-6 text-gray-900"
              >
